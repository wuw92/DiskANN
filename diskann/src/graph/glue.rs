...
/// A light-weight, synchronous alternative to [`crate::provider::Delete`], targeted at quickly
/// filtering out deleted IDs during search post-processing.
///
...
impl<A, T> SearchPostProcess<A, T> for RemoveDeletedIdsAndCopy
where
